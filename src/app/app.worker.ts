...
wasi = new WASI({
  ...
  args: [wasmFilePath, JSON.stringify(data.casesaggregated), JSON.stringify(data.products), JSON.stringify(data.helpExipiary), JSON.stringify(data.populationdensity), data.incubationmax, data.incubationmin],
